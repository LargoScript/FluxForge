...
export class ParticleSystem {
  ...
  public updateConfig(newConfig: ParticleConfig) {
    ...
    // Only re-init particles if count changes.
    // This allows color/speed changes without resetting positions.
    if (newConfig.particleCount !== undefined && newConfig.particleCount !== prevCount) {
      this.initParticles(); 
    }
  }
